...
def parser():
    ...
    parser.add_argument(
        ...
        "--misato_dir",
        type=str,
        default="/Matter/misato_database/",
...
if __name__ == "__main__":
    ...
    features["H"] = nearl.features.AtomType(
        selection="!:MOL",
        focus_element=1,
    ...
    features["C"] = nearl.features.AtomType(
        selection="!:MOL",
        focus_element=6,
    ...
    features["N"] = nearl.features.AtomType(
        selection="!:MOL",
        focus_element=7,
    ...
    features["O"] = nearl.features.AtomType(
        selection="!:MOL",
        focus_element=8,
    ...
    features["S"] = nearl.features.AtomType(
        selection="!:MOL",
        focus_element=16,
    ...
    features["H_"] = nearl.features.AtomType(
        selection=":MOL",
        focus_element=1,
        outkey="static_H_lig",
        cutoff=VOX_cutoff,
    ...
    features["C_"] = nearl.features.AtomType(
        selection=":MOL",
        focus_element=6,
        outkey="static_C_lig",
        cutoff=VOX_cutoff,
    ...
    features["N_"] = nearl.features.AtomType(
        selection=":MOL",
        focus_element=7,
        outkey="static_N_lig",
        cutoff=VOX_cutoff,
    ...
    features["O_"] = nearl.features.AtomType(
        selection=":MOL",
        focus_element=8,
        outkey="static_O_lig",
        cutoff=VOX_cutoff,
    ...
    features["S_"] = nearl.features.AtomType(
        selection=":MOL",
        focus_element=16,
        outkey="static_S_lig",
        cutoff=VOX_cutoff,
    ...
    features["obs_lig_anno"] = nearl.features.MarchingObservers(
        selection=":MOL",
        weight_type="uniformed",
        obs="distinct_count",
        agg="standard_deviation",
        outkey="mo_PCount_lig",
        cutoff=VOX_cutoff,
        sigma=VOX_sigma,
    )
    features["obs_prot_anno"] = nearl.features.MarchingObservers(
        selection="!:MOL",
        weight_type="uniformed",
        obs="distinct_count",
        agg="standard_deviation",
        outkey="mo_PCount_prot",
        cutoff=VOX_cutoff,
        sigma=VOX_sigma,
    )
    ...
    features["feat_SML"] = nearl.features.DensityFlow(
        selection=":MOL",
        weight_type="uniformed",
        agg="mean",
        outkey="pdf_PM_lig",
    ...
    features["feat_SSL"] = nearl.features.DensityFlow(
        selection=":MOL",
        weight_type="uniformed",
        agg="standard_deviation",
        outkey="pdf_PS_lig",
    ...
    features["feat_SMP"] = nearl.features.DensityFlow(
        selection="!:MOL",
        weight_type="uniformed",
        agg="mean",
        outkey="pdf_PM_prot",
    ...
    features["feat_SSP"] = nearl.features.DensityFlow(
        selection="!:MOL",
        weight_type="uniformed",
        agg="standard_deviation",
        outkey="pdf_PS_prot",
    ...
    features["stepping"] = nearl.features.LabelStepping(
        baseline_map=nearl.data.GENERAL_SET, outkey="pk_stepping"
    )
    features["label_pcdt"] = nearl.features.LabelPCDT(
        selection=":MOL", baseline_map=nearl.data.GENERAL_SET, outkey="label_pcdt"
    )
