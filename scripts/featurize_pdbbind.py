...
def parser():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="The template string to locate pdb file, e.g. {}_complex.pdb where {} is replaced by the pdb code listed in the --pdbcodes argument",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "-l", "--length", type=int, default=20, help="The length of the bounding box"
    )
    parser.add_argument(
        "-c",
        "--cutoff",
    ...
    parser.add_argument(
        "--cpu_nr", type=int, default=6, help="The number of CPUs to use"
    )
    parser.add_argument(
        "--h5prefix",
        type=str,
...
def commandline_interface(args, trajlist, pdbids):
    ...
    outputfile = os.path.join(
        ...
        f"{args.get('h5prefix')}{args.get('task_index')}.h5",
    )
    ...
    print(
        f"Featurization follows: Length: {VOX_length} | Dimension: {VOX_dim} | Cutoff: {VOX_cutoff} | Sigma: {VOX_SIGMA}"
    )

    featureset = OrderedDict()
    featureset["all_ann"] = nearl.features.Selection(
        selection=":*", outkey="all_annotation", cutoff=VOX_cutoff, sigma=VOX_SIGMA
    )
    featureset["lig_ann"] = nearl.features.Selection(
        selection="!:LIG", outkey="lig_annotation", cutoff=VOX_cutoff, sigma=VOX_SIGMA
    )
    featureset["prot_ann"] = nearl.features.Selection(
        selection=":LIG", outkey="prot_annotation", cutoff=VOX_cutoff, sigma=VOX_SIGMA
    )

    featureset["aromatic"] = nearl.features.Aromaticity(
        selection=":*", outkey="aromatic", cutoff=VOX_cutoff, sigma=VOX_SIGMA
    )
    featureset["hb_donor"] = nearl.features.HBondDonor(
        selection=":*", outkey="hb_donor", cutoff=VOX_cutoff, sigma=VOX_SIGMA
    )
    featureset["hb_acceptor"] = nearl.features.HBondAcceptor(
        selection=":*", outkey="hb_acceptor", cutoff=VOX_cutoff, sigma=VOX_SIGMA
    )
    featureset["H"] = nearl.features.AtomType(
        selection=":*",
        focus_element=1,
        outkey="static_H",
        cutoff=VOX_cutoff,
    ...
    featureset["C"] = nearl.features.AtomType(
        selection=":*",
        focus_element=6,
        outkey="static_C",
        cutoff=VOX_cutoff,
    ...
    featureset["N"] = nearl.features.AtomType(
        selection=":*",
        focus_element=7,
        outkey="static_N",
        cutoff=VOX_cutoff,
    ...
    featureset["O"] = nearl.features.AtomType(
        selection=":*",
        focus_element=8,
        outkey="static_O",
        cutoff=VOX_cutoff,
    ...
    featureset["S"] = nearl.features.AtomType(
        selection=":*",
        focus_element=16,
        outkey="static_S",
        cutoff=VOX_cutoff,
    ...
    # Aromaticity
    featureset["aromatic"] = nearl.features.Aromaticity(
        selection="!:LIG", outkey="aromatic_prot", cutoff=VOX_cutoff, sigma=VOX_SIGMA
    )
    featureset["aromatic_"] = nearl.features.Aromaticity(
        selection=":LIG", outkey="aromatic_lig", cutoff=VOX_cutoff, sigma=VOX_SIGMA
    )
    # HB donor/acceptor
    featureset["hb_donor"] = nearl.features.HBondDonor(
        selection="!:LIG", outkey="hb_donor_prot", cutoff=VOX_cutoff, sigma=VOX_SIGMA
    )
    featureset["hb_donor_"] = nearl.features.HBondDonor(
        selection=":LIG", outkey="hb_donor_lig", cutoff=VOX_cutoff, sigma=VOX_SIGMA
    )
    featureset["hb_acceptor"] = nearl.features.HBondAcceptor(
        selection="!:LIG", outkey="hb_acceptor_prot", cutoff=VOX_cutoff, sigma=VOX_SIGMA
    )
    featureset["hb_acceptor_"] = nearl.features.HBondAcceptor(
        selection=":LIG", outkey="hb_acceptor_lig", cutoff=VOX_cutoff, sigma=VOX_SIGMA
    )

    featureset["H"] = nearl.features.AtomType(
        selection="!:LIG",
        focus_element=1,
        outkey="static_H_prot",
        cutoff=VOX_cutoff,
        sigma=VOX_SIGMA,
    )
    featureset["C"] = nearl.features.AtomType(
    ...
    featureset["S"] = nearl.features.AtomType(
        selection="!:LIG",
        focus_element=16,
        outkey="static_S_prot",
        cutoff=VOX_cutoff,
        sigma=VOX_SIGMA,
    )
    featureset["H_"] = nearl.features.AtomType(
        selection=":LIG",
        focus_element=1,
        outkey="static_H_lig",
        cutoff=VOX_cutoff,
    ...
    featureset["C_"] = nearl.features.AtomType(
        selection=":LIG",
        focus_element=6,
        outkey="static_C_lig",
        cutoff=VOX_cutoff,
    ...
    featureset["N_"] = nearl.features.AtomType(
        selection=":LIG",
        focus_element=7,
        outkey="static_N_lig",
        cutoff=VOX_cutoff,
    ...
    featureset["O_"] = nearl.features.AtomType(
        selection=":LIG",
        focus_element=8,
        outkey="static_O_lig",
        cutoff=VOX_cutoff,
    ...
    featureset["S_"] = nearl.features.AtomType(
        selection=":LIG",
        focus_element=16,
        outkey="static_S_lig",
        cutoff=VOX_cutoff,
    ...
    featureset["pk"] = nearl.features.LabelAffinity(
        baseline_map=nearl.data.GENERAL_SET, outkey="pk_original"
    )
    ...
    trajloader = nearl.io.TrajectoryLoader(
        trajlist, superpose=True, mask="!:T3P", trajid=pdbids
    )
...
if __name__ == "__main__":
    ...
    if len(complex_files) != len(pdbids):
        raise ValueError(
            "The number of pdbids does not match the number of complex files"
        )
