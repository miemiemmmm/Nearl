...
class KDeepNetwork(nn.Module):
  """
  box_shape is not currently used. It is a placeholder for future use if needed.
  """
  def __init__(self, input_channel_number: int, 
               output_dimension: int,
               box_shape = None
               ):
    super(KDeepNetwork, self).__init__()
    self.conv1 = nn.Conv3d(input_channel_number, 96, kernel_size=1, stride=2)
    ...
    self.dense1 = nn.Linear(512*2*2*2, output_dimension)
