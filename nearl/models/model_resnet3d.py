...
class ResNet3D(nn.Module):
  def __init__(self, 
    ...
    model.conv1 = nn.Conv3d(channel_in, 64, kernel_size=7, stride=2, padding=3, bias=False) 
    nn.init.kaiming_normal_(model.conv1.weight, mode='fan_out', nonlinearity='relu')


    # Get the input feature number of the model.fc
    feature_number = model.fc.in_features
    model.fc = nn.Linear(feature_number, output_dim)
    self.model = model
